...
// Evaluation Engine
export { OptimizationEngine } from './engines/OptimizationEngine';
export { ParameterPipeline } from './engines/ParameterPipeline';
...
export function createConstraintSystem(config?: ConstraintSystemConfig): ConstraintSystemV2 {
  const engine = new OptimizationEngine(config?.engine);
