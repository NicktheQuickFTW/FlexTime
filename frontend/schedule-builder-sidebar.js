...
function ScheduleBuilderSidebar({ 
  ...
  async function handleGenerateSchedule() {
    try {
      ...
      // Update the active schedule in the schedule builder
...
// Export components
window.ScheduleBuilderSidebar = ScheduleBuilderSidebar;
