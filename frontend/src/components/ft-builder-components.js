...
function FTBuilderHeader({ 
  ...
  return React.createElement('header', { className: 'schedule-builder-header' }, [
      ...
      React.createElement('div', { className: 'brand-section', key: 'brand' }, [
        ...
        React.createElement('div', { className: 'brand-text', key: 'brand-text' }, [
          React.createElement('h1', { className: 'app-title', key: 'title' }, [
            ...
            React.createElement('span', { className: 'title-sub', key: 'sub' }, 'FT BUILDER')
          ]),
    ...
    // Center Section - AI Status Grid centered to align with schedule view toggle
...
// Sub-header for collaboration and actions
function FTBuilderSubHeader({ activeUsers, agentStatus, onGenerateSchedule, onOptimizeSchedule }) {
  return React.createElement('div', { className: 'schedule-builder-subheader' }, [
    React.createElement('div', { className: 'subheader-left', key: 'left' }, [
...
// Export components
window.FTBuilderHeader = FTBuilderHeader;
