...
function FTBuilderApp() {
  ...
  if (loading || big12Teams.length === 0) {
    return React.createElement('div', { className: 'schedule-builder-loading' }, [
      React.createElement('div', { className: 'loading-content', key: 'loading' }, [
        ...
        React.createElement('h3', { key: 'title' }, 'Loading FlexTime FT Builder...'),
  ...
  return React.createElement('div', { className: 'schedule-builder-app' }, [
    ...
    React.createElement(FTBuilderHeader, {
      key: 'header',
      currentView,
      setCurrentView,
      selectedSport,
    ...
    React.createElement('div', { className: 'schedule-builder-main', key: 'main' }, [
      ...
      // Left Column - Sub-header + Sidebar
      React.createElement('div', { className: 'schedule-builder-left-column', key: 'left-column' }, [
        // Sub-header with collaboration and action buttons
        React.createElement(FTBuilderSubHeader, {
          key: 'subheader',
          activeUsers,
          agentStatus,
          onGenerateSchedule: handleAIGeneration,
...
window.FTBuilderApp = FTBuilderApp;