...
export const VENUE_TYPES = {
  ...
  2: { id: 2, name: 'Arena/Gymnasium', sport_codes: ['MBB', 'WBB', 'VB', 'WRE'] },
  3: { id: 3, name: 'Baseball Complex', sport_codes: ['BSB'] },
  4: { id: 4, name: 'Softball Complex', sport_codes: ['SB'] },
  5: { id: 5, name: 'Soccer Field', sport_codes: ['SOC'] },
...
export const BIG12_AFFILIATES = {
  ...
  21: {
    ...
    short_display: 'Fresno State',
    preferred_school_name: 'Fresno State',
    location: 'Fresno, CA',
    mascot: 'Bulldogs',
    primary_color: '#CC0033',
  ...
  23: {
    ...
    short_display: 'North Dakota State',
    preferred_school_name: 'NDSU',
    location: 'Fargo, ND',
    mascot: 'Bison',
...
export function generateBig12Teams() {
  ...
  const schoolSports = {
    1: [1, 2, 3, 8, 14, 15, 18, 19, 24], // Arizona
    2: [1, 2, 3, 8, 14, 15, 18, 19, 24, 25], // Arizona State (+ Wrestling)
    3: [1, 2, 3, 8, 14, 15, 18, 19, 24], // Baylor
    4: [1, 2, 3, 8, 14, 15, 18, 19, 24], // BYU
    5: [1, 2, 3, 8, 14, 15, 18, 19, 24], // UCF
    6: [2, 3, 8, 14, 24], // Cincinnati (no baseball, softball, tennis)
    7: [2, 3, 8, 14, 24], // Colorado
    8: [1, 2, 3, 8, 14, 15, 24], // Houston
    9: [2, 3, 8, 14, 15, 24, 25], // Iowa State
    ...
    15: [1, 2, 3, 8, 14, 15, 18, 19, 24], // Utah
    16: [2, 3, 8, 14, 24, 25] // West Virginia
  };
