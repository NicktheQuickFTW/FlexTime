...
const SCALE_CONFIG = {
  ...
  phase1: {
    ...
    workers: {
      maxWorkersPerTask: parseInt(process.env.MAX_WORKERS_PER_TASK || '10', 10), // Default 10 workers per task
      maxParallelOperations: parseInt(process.env.MAX_PARALLEL_OPERATIONS || '10', 10), // Default 10 parallel operations
      enableParallelScheduling: process.env.USE_PARALLEL_SCHEDULING !== 'false' // Default enabled
    },
