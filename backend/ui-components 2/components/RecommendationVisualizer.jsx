/**
 * Context7 Recommendation Visualizer
 * 
 * This component visualizes schedule recommendations provided by the Context7 
    ...
    <Box sx={{ width: '100%' }}>
      <Box sx={{ mb: 2 }}>
        ...
        <Typography variant="body2" color="textSecondary" gutterBottom>
          {filteredRecs.length} recommendation{filteredRecs.length !== 1 ? 's' : ''} generated by Context7
        </Typography>
      </Box>
